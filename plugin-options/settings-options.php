...
$settings = array(
	'settings' => array(
		...
		'expiration_warning_days'                         => array(
			'name'      => __( 'Expiration warning interval (days)', 'yith-point-of-sale-for-woocommerce' ),
			'desc'      => __( 'Show a warning when an expiration date is within this number of days. Expired entries will show a red notice.', 'yith-point-of-sale-for-woocommerce' ),
			'type'      => 'yith-field',
			'yith-type' => 'number',
			'id'        => 'yith_pos_expiration_warning_days',
			'default'   => 30,
			'min'       => 0,
			'step'      => 1,
		),
		'pos_disable_restock_on_refund'                  => array(
			'name'      => __( 'Disable restock on refund (POS)', 'yith-point-of-sale-for-woocommerce' ),
			'desc'      => __( 'When enabled, refunded POS orders will not restock items automatically. Manage stock manually after refunds.', 'yith-point-of-sale-for-woocommerce' ),
			'type'      => 'yith-field',
			'yith-type' => 'onoff',
			'id'        => 'yith_pos_disable_restock_on_refund',
			'default'   => 'yes',
		),
